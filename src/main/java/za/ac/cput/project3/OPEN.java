 ...
 */
public class OPEN  extends Frame implements ActionListener
{
...
public OPEN()
{
        ...
        ImageIcon imageIcon = new ImageIcon(new ImageIcon("mainImage.jpeg").getImage().getScaledInstance(900, 600, Image.SCALE_AREA_AVERAGING));
        ...
        lblSchoolName = new JLabel("CPUT TOTORIAL ");
        lblSchoolName.setForeground(Color.YELLOW);
        lblSchoolName.setFont(new Font("Serif", Font.BOLD, 24));
